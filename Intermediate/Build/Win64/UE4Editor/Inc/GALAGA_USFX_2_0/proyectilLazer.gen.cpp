...
#include "GALAGA_USFX_2_0/proyectilLazer.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	GALAGA_USFX_2_0_API UClass* Z_Construct_UClass_AproyectilLazer_NoRegister();
	GALAGA_USFX_2_0_API UClass* Z_Construct_UClass_AproyectilLazer();
...
// End Cross Module References
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AproyectilLazer_Statics::NewProp_mallaProyectil_MetaData[] = {
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AproyectilLazer_Statics::NewProp_mallaProyectil = { "mallaProyectil", nullptr, (EPropertyFlags)0x00100000000a001d, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AproyectilLazer, mallaProyectil), Z_Construct_UClass_UStaticMeshComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AproyectilLazer_Statics::NewProp_mallaProyectil_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AproyectilLazer_Statics::NewProp_mallaProyectil_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AproyectilLazer_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AproyectilLazer_Statics::NewProp_mallaProyectil,
	};
	...
	IMPLEMENT_CLASS(AproyectilLazer, 2440656658);
	template<> GALAGA_USFX_2_0_API UClass* StaticClass<AproyectilLazer>()
	{
		return AproyectilLazer::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AproyectilLazer(Z_Construct_UClass_AproyectilLazer, &AproyectilLazer::StaticClass, TEXT("/Script/GALAGA_USFX_2_0"), TEXT("AproyectilLazer"), false, nullptr, nullptr, nullptr);
